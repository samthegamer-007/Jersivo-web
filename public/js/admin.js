...
// Team code mapping
const TEAM_CODES = {
    'BAR': 'BAR', 'RMA': 'RMA', 'MCI': 'MCI', 'MUN': 'MUN',
    'CHE': 'CHE', 'ARS': 'ARS', 'LIV': 'LIV', 'TOT': 'TOT',
    'BAY': 'BAY', 'DOR': 'DOR', 'JUV': 'JUV', 'INT': 'INT',
    'PSG': 'PSG', 'ATM': 'ATM', 'MIA': 'MIA', 'ARG': 'ARG',
    'BRA': 'BRA', 'FRA': 'FRA', 'ESP': 'ESP', 'ENG': 'ENG',
    'GER': 'GER', 'POR': 'POR', 'NED': 'NED', 'OTH': 'OTH'
};
...
function updateSKUPreview() {
    ...
    const teamCode = form.teamCode.value;
